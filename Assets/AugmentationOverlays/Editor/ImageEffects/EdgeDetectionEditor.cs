...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class EdgeDetectionEditor : Editor
    {
        ...
        public override void OnInspectorGUI () {
            ...
            GUILayout.Label("Detects spatial differences and converts into outlines", EditorStyles.miniBoldLabel);
     ...
     //       EditorGUILayout.PropertyField (edgesOnlyBgColor, new GUIContent (" Color"));
            EditorGUILayout.PropertyField(edgesColor, new GUIContent(" EdgeColor"));
