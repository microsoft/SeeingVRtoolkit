// A shader from a post on Unity Community
 // https://answers.unity.com/questions/1479370/how-can-i-change-magnification-based-on-alpha-valu.html

Shader "Custom/Magnificatin" {
	Properties {
